...
namespace app.ApiConfiguration.Swagger
{
    /// <summary>
    ...
    public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        static OpenApiInfo CreateInfoForApiVersion( ApiVersionDescription description, IConfiguration configuration )
        {
            ...
            {
                Title = configuration.GetValue<string>("AppInformation:title"),
                Version = description.ApiVersion.ToString(),
                Description = configuration.GetValue<string>("AppInformation:description"),
                Contact = new OpenApiContact() { Name = "Luis Lessa", Url = new Uri("https://github.com/luispaulojr") },
